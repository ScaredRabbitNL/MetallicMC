...
public enum ModArmorMaterial implements ArmorMaterial {
    SCARED_RABBITIUM("scared_rabbitium", 41, new int[] {5, 11, 9 ,6 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0F, 0.2f, () -> Ingredient.ofItems(ModItems.SCARED_RABBITIUM_INGOT));
    ...
    public String getName() {
        return MetallicMC.MOD_ID + ":" + this.name;
    }
